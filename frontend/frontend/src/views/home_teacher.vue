<template>
  <div class="admin-layout">
    ...
    <div class="main">
      <!-- 顶部导航栏 -->
      <header class="header">
        <div class="header-title">教师后台管理系统</div>
            ...
            <div class="todo-list">
              ...
              <div class="todo-item">
                <input
                  ...
                  checked
                >
                <span class="completed">更新数据结构课程大纲</span>
              </div>
            </div>
          </div>
        </div>
