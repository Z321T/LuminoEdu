...
```python
# server/app/models/course_exercise.py
...
class CourseExercise(models.Model):
    ...
    course = fields.ForeignKeyField(
        "models.Course_th", related_name="exercises",
...
```python
# 导入所有模型
from .course import Course_th, CourseStudent, CourseStatus
...
# 导出所有模型
__all__ = [
    'Course_th', 'CourseStudent', 'CourseStatus',
    'Student',
    'Teacher',
    'Admin',
...
```python
# server/app/services/exercise_generator.py
import openai
import json
import os
from typing import List, Dict, Any
from app.models import CourseExercise, ExerciseType, Course_th, Teacher
...
class ExerciseGenerator:
    ...
    async def generate_exercises(
        ...
        # 获取课程和教师实例
        course = await Course_th.get(id=course_id)
...
```python
# 更新 server/app/services/exercise_generator.py
